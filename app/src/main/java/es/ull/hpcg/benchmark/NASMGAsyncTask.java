...
public class NASMGAsyncTask extends AsyncTask<String, Void, List<String>> {
    WeakReference<Activity> mWeakActivity;

    public NASMGAsyncTask(Activity activity) {
    ...
    protected List<String> doInBackground(String... values) {
        ...
        try{
            mg = new MG(values[0].charAt(0), threads, serial);
