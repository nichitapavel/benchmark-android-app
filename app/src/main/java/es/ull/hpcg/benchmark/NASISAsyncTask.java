...
public class NASISAsyncTask extends AsyncTask<String, Void, List<String>> {
    WeakReference<Activity> mWeakActivity;

    public NASISAsyncTask(Activity activity) {
    ...
    protected List<String> doInBackground(String... values) {
        ...
        try{
            is = new IS(values[0].charAt(0), threads, serial);
